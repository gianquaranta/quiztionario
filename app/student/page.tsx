                ...
                <CardContent className="text-center py-16">
                  {state.currentSessionCode ? (
                    <>
                      ...
                      <h3 className="text-2xl font-bold text-slate-800 mb-4">¡Esperando la Próxima Pregunta! 🚀</h3>
                      <p className="text-slate-600 text-lg">
            ...
            {!state.questionActive && state.currentSessionCode && hasResponded && (
              <Card className="mt-6 bg-blue-50 border border-blue-200">
                <CardContent className="text-center py-8">
                  ...
                  <h3 className="text-xl font-bold text-blue-800 mb-2">¡Pregunta Finalizada!</h3>
                  <p className="text-blue-600">El profesor ha cerrado la pregunta. ¡Prepárate para la siguiente! 🎯</p>
                  {responseTime && (
